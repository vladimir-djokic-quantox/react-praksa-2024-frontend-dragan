...
const CheckoutForm = () => {
  ...
  const totalPrice = cartData.me.cart.data.attributes.dishes.data
    ...
    return (
      <div className="max-w-2xl mx-auto my-8 p-6 bg-white rounded-lg shadow-md">
        ...
        <p className="text-gray-800">
          <strong>Shipping Address:</strong> {streetAddress}, {city}, {zipCode}
        </p>
      </div>
    );
  }
    ...
    <div className="max-w-2xl mx-auto my-8 p-6 bg-white rounded-lg shadow-md">
      ...
      <ul>
        {cartData.me.cart.data.attributes.dishes.data.map((dish, index) => (
          ...
          >
            ...
            <span className="font-semibold">{`${dish.attributes.price.toFixed(
              2
            )} RSD`}</span>
          </li>
        ))}
      ...
      {orderSubmitted ? (
        <div className="mt-6">
          ...
          <p className="text-gray-800">
            <strong>Shipping Address:</strong> {streetAddress}, {city},{" "}
            {zipCode}
          </p>
          <button
